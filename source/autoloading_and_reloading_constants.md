...
Относительные ссылки считаются отсутствующими в cref места, где они вызваны, а ограниченные ссылки считаются отсутствующими в их parent (определение *cref* смотрите в [Алгоритмы резолюции для относительных констант](#resolution-algorithm-for-relative-constants) в начале этого руководства, а определение *parent* — в [Алгоритмы резолюции для ограниченных констант](#resolution-algorithm-for-qualified-constants))
