...
- [Asset Pipeline](/asset-pipeline) := Это руководство документирует конвейер ресурсов (asset pipeline)
...
- [Версия 7.2 - ?](/7_2_release_notes) := Заметки о релизе Rails 7.2
- [Версия 7.1 - Октябрь 2023](/7_1_release_notes) := Заметки о релизе Rails 7.1
