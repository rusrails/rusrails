...
Этот раздел представляет пошаговое руководство для создании задания и добавления его в очередь.
...
Active Job предоставляет хуки на протяжение жизненного цикла задания. Колбэки позволяют включить логику в жизненный цикл задания.
...
class GuestsCleanupJob < ApplicationJob
  ...
  before_enqueue do |job|
    # делаем что-то с экземпляром задания
  end
...
Вы можете найти подробные инструкции о том, как тестировать ваши задания в [руководстве по тестированию](a-guide-to-testing-rails-applications#jobs-testing).
