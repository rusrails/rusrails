...
Вы можете найти подробные инструкции о том, как тестировать ваши задачи в [руководстве по тестированию](a-guide-to-testing-rails-applications#testirovanie-zadach).
