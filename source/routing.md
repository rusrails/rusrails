...
Роутер Rails распознает URL и сопоставляет его с экшном контроллера или с приложением Rack. Он также может создавать пути и URL, избегая необходимость жестко прописывать строки в ваших вьюхах.
