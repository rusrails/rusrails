...
Turbolinks добавляет обработчик кликов на всех тегах `<a>` на странице. Если ваш браузер поддерживает [PushState](https://developer.mozilla.org/ru/docs/Web/API/History_API#%D0%9C%D0%B5%D1%82%D0%BE%D0%B4_pushState()),
