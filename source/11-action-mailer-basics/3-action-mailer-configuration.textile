...
|+default_options+|Позволит вам установить значения по умолчанию для опций метода <tt>mail</tt> (<tt>:from</tt>, <tt>:reply_to</tt> и т.д.).|
