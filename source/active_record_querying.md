...
В случае, когда не было использовано выражение `reselect`,
...
Полную документацию об enum можно прочитать в [документации Rails API](https://api.rubyonrails.org/classes/ActiveRecord/Enum.html).
