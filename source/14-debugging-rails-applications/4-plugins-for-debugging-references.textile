...
* "Домашняя страница ruby-debug":http://www.datanoise.com/ruby-debug
...
* "Скринкаст Ryan Bate's ruby-debug":http://railscasts.com/episodes/54-debugging-with-ruby-debug
* "Скринкаст Ryan Bate's stack trace":http://railscasts.com/episodes/24-the-stack-trace
* "Скринкаст Ryan Bate's logger":http://railscasts.com/episodes/56-the-logger
...
* "Документация по Bleak House":http://blog.evanweaver.com/files/doc/fauna/bleak_house/files/README.html
