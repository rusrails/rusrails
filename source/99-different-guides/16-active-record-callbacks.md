...
После прочтения этого руководства и опробования представленных концепций, мы надеемся, что вы сможете:

* Понимать жизненный цикл объектов Active Record
* Создавать методы колбэков, отвечающих на события в жизненном цикле объекта
* Создавать специальные классы, инкапсулирующих обычное поведение для ваших колбэков
