...
Вы можете либо открыть пул-реквест в [Rails](https://github.com/rails/rails) или попросить [основную команду Rails](http://rubyonrails.org/community/#core) открыть доступ к docrails, если вы вносите вклад регулярно. Пожалуйста, не открывайте пул-реквесты в docrails, если хотите получить обратную связь на свои изменения, попросите ее лучше в [Rails](https://github.com/rails/rails).
...
* **Польский**: [https://github.com/apohllo/docrails/tree/master](https://github.com/apohllo/docrails/tree/master)
