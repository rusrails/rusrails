...
При работе с документацией принимайте во внимание [TODO: руководство по документации API](/api_documentation_guidelines) и [TODO: руководство по руководствам по Ruby on Rails](/ruby_on_rails_guides_guidelines).
...
#### Следуйте соглашениям по программированию
