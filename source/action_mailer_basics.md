...
#### Создание URL с помощью именнованных маршрутов
...
| ----------------------- | -------- |
| `logger`                | logger используется для создания информации на ходу, если возможно. Можно установить как `nil` для отсутствия логирования. Совместим как с `Logger` в Ruby, так и с логером `Log4r`.|
