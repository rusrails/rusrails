...
- Генерация URL: Обратной стороной роутинга является генерация URL. Хороший API, основанный на HTTP, включает URL-ы (в качестве примера смотрите [GitHub Gist API](http://developer.github.com/v3/gists/)).
