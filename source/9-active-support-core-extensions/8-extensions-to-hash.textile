...
h5. +transform_keys+ и +transform_keys!+ (Rails4)
...
Кроме этого, можно использовать +deep_stringify_keys+ и +deep_stringify_keys!+ для приведения к строке всех ключей в заданном хэше и всех хэшах, вложенных в него. Пример результата: (Rails4)
...
Кроме этого, можно использовать +deep_symbolize_keys+ и +deep_symbolize_keys!+ для приведения к символам всех ключей в заданном хэше и всех хэшах, вложенных в него. Пример результата: (Rails4)
