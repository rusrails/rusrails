...
INFO. Это руководство документирует автоматическую загрузку в режиме `classic`, являющимся традиционным. Если, вместо этого, вы хотите прочитать о режиме `zeiwerk`, новинкой Rails 6, смотрите [Автозагрузка и перезагрузка констант (режим Zeitwerk)](/autoloading_and_reloading_constants).
