...
Чтобы установить методы компрессии ресурсов, установить соответствующие конфигурационные опции в `production.rb` - `config.assets.css_compressor` для CSS и `config.assets.js_compressor` для JavaScript:
