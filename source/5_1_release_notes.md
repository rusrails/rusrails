...
Эти заметки о релизе покрывают только основные изменения. Чтобы узнать о других обновлениях, различных багфиксах и изменениях, обратитесь к логам изменений или к [списку коммитов](https://github.com/rails/rails/commits/5-1-stable) в главном репозитории Rails на GitHub.
...
Сейчас Rails позволяет управлять секретными данными приложения безопасным образом, наподобие гема [sekrets](https://github.com/ahoward/sekrets).
