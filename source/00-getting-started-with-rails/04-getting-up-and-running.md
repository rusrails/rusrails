...
Партиалы (`partials`) - это то, что использует Rails для устранения повторения во вьюхах. Вот простой пример:
...
Зайдите в браузере на [http://localhost:3000/posts/new](http://localhost:3000/posts/new) и попытайтесь создать новую публикацию. Все работает. Теперь попытайтесь отредактировать публикацию, и вы получите следующую ошибку:
