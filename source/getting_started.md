...
Если работаете в Windows, необходимо установить [Ruby Installer Development Kit](http://rubyinstaller.org/downloads/).
...
Настало время добавить вторую модель в приложение. Вторая модель будет управлять комментариями в статье.
