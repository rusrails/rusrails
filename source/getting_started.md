...
Rails представляет метод `resources`, который используется для объявления стандартного ресурса REST. Вам необходимо добавить _ресурс article_ в `config/routes.rb`, как представлено ниже.
