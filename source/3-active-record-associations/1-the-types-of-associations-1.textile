...
!/system/images/belongs_to.png(Диагармма для связи belongs_to)!
...
!/system/images/has_one.png(Диагармма для связи has_one)!
...
!/system/images/has_many.png(Диагармма для связи has_many)!
...
!/system/images/has_many_through.png(Диагармма для связи has_many :through)!
...
!/system/images/has_one_through.png(Диагармма для связи has_one :through)!
...
!/system/images/habtm.png(Диагармма для связи has_and_belongs_to_many)!
