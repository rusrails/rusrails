...
h4. Предотвращение коллизий имен
...
h5. Создание внешних ключей для связей +belongs_to+
...
h5. Создание соединительных таблиц для связей +has_and_belongs_to_many+
...
h4. Управление областью видимости связей
...
* Они не работают со связями <tt>:through</tt>.
* Они не работают со связями <tt>:polymorphic</tt>.
* Они не работают со связями  <tt>:as</tt>.
