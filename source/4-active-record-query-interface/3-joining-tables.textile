...
Active Record позволяет использовать имена "связей":/active-record-associations, определенных в модели, как ярлыки для определения для определения условия +JOIN+ для этих связей при использовании метода +joins+.
