...
INFO: Кэширование страниц было убрано из Rails 4. Обратитесь к [гему actionpack-page_caching](https://github.com/rails/actionpack-page_caching). Так же взгляните  [Обзорную статью DHH по прекращению кэша, основанного на ключе](http://37signals.com/svn/posts/3113-how-key-based-cache-expiration-works) для вновь-предпочтительного метода.
...
INFO: Кэширование экшна было убрано из Rails 4. Обратитесь к [гему actionpack-action_caching](https://github.com/rails/actionpack-action_caching). Так же взгляните  [Обзорную статью DHH по прекращению кэша, основанного на ключе](http://37signals.com/svn/posts/3113-how-key-based-cache-expiration-works) для вновь-предпочтительного метода.
