...
Файл JavaScript в приложении Rails или Rails Engine размещается в одном из трех мест: `app/assets`, `lib/assets` или `vendor/assets`. Эти места детально описаны в разделе про [организацию ресурсов](/asset-pipeline#how-to-use-the-asset-pipeline) в руководстве по Asset Pipeline.
