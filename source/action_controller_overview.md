...
Представим сценарий, когда вы хотите поместить в белый список атрибут, содержащий хэш с любыми ключами. Используя strong parameters нельзя разрешить хэш с любыми ключами, но вы можете использовать простое присвоение для выполнения задачи:
