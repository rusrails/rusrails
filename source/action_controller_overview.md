...
Для того, чтобы использовать эту функцию, вам необходимо использовать не буферизирующий сервер, такой как [Puma](http://puma.io), [Rainbows](http://rainbows.bogomips.org)
