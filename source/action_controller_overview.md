...
Не забывайте установить правильный код статуса в контроллере, как показано выше.

WARNING: Следует избегать использования базы данных или какие-либо сложные операции, так как пользователь уже на странице ошибке. Вызов еще одной ошибки на странице ошибки приведет к проблемам.
