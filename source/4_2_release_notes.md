...
Например, если `trashable` это объект Active Record, тогда это задание будет работать без необходимости сериализации:
...
*   Хелперы форм больше не генерируют элемент `<div>` с inline CSS вокруг скрытых полей.
